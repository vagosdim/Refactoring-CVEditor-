...
public class ChronologicalJFrameWindow extends JDialog{
	...
	public ChronologicalJFrameWindow(final JFrame appMainWindow) {
		...
		ChronologicalJFrameWindow.getContentPane().add(chckbxTxt);
		...
		ChronologicalJFrameWindow.getContentPane().add(chckbxTex);
		
		JButton btnSave = new JButton("Save");
		btnSave.setBounds(552, 258, 152, 52);
		ChronologicalJFrameWindow.getContentPane().add(btnSave);
	...
	public static void eventListenerDate(JButton btnDate, String type){
		btnDate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				JLabel label_2 = new JLabel("Establishment");
					...
					public void actionPerformed(ActionEvent e) {
						if (list.getSelectedIndex() != -1){
							if (!textField_1.getText().equals(" ") && !textField_2.getText().equals(" ") 
									&& !textField_3.getText().equals(" ") &&!dateField.getText().equals(" ") ){
