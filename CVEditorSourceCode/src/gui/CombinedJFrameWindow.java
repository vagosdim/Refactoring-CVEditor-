				...
				add.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						if ((!textField_1.getText().equals("")) &&
							...
							if (type.equals("Education And Training")){
								educationAndTraining.add((textField_1.getText() + ", " + textField_2.getText()
								  + ", " + textField_3.getText() + ", " + dateField.getText()));		
								mainList.addElement(textField_1.getText() + ", " + textField_2.getText() + ", " + 
								  textField_3.getText() + ", " + dateField.getText());
								list.setModel(mainList);
								
							} else if (type.equals("Further Courses")){
								furtherCourses.add((textField_1.getText() + ", " + textField_2.getText() + ", " 
								  + textField_3.getText() + ", " + dateField.getText()));		
								mainList.addElement(textField_1.getText() + ", " + textField_2.getText() + ", "
								  + textField_3.getText() + ", " + dateField.getText());
								list.setModel(mainList);
